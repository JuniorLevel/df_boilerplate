...
declare module 'lodash/fp' {
	...
	declare type Lodash = {|
		...
		flattenDepth: ((
			depth: number
		) => (array: $ReadOnlyArray<any>) => Array<any>) &
		...
		) => (values: $ReadOnlyArray<any>) => Object) &
		...
		partialRight: ((
			func: Function
		) => (partials: $ReadOnlyArray<any>) => Function) &
			((func: Function, partials: $ReadOnlyArray<any>) => Function),
